...
namespace esp_brookesia::apps
{
    ...
    MusicPlayer::MusicPlayer(bool use_status_bar, bool use_navigation_bar) : systems::phone::App(
                                                                                 "MusicPlayer", &img_app_musicplayer, true, use_status_bar, use_navigation_bar
                                                                             ),
                                                                             _file_iterator(NULL)
    {
    }
