...
namespace esp_brookesia::apps
{
    ...
    SoundPage::SoundPage(bool use_status_bar, bool use_navigation_bar)
        : systems::phone::App("Sound", nullptr, true, use_status_bar, use_navigation_bar), label(nullptr)
    {
    }
    ...
    bool SoundPage::run()
    {
        ...
        lv_obj_t *text_obj = lv_list_add_text(list1, "Volume");
        ...
        lv_obj_set_height(slider_container, round_display::slider_row_height(110));
        ...
        lv_obj_set_style_bg_color(volume_slider, lv_color_hex(0x00BFFF), LV_PART_INDICATOR);
