...
constexpr uint32_t STYLESHEET_DEFAULT_CUSTOM_CORE_DISPLAY_BG_COLOR = 0x1A1A1A;

constexpr base::Display::Data STYLESHEET_DEFAULT_CUSTOM_CORE_DISPLAY_DATA = {
    .background = {
        .color = gui::StyleColor::COLOR(STYLESHEET_DEFAULT_CUSTOM_CORE_DISPLAY_BG_COLOR),
...
constexpr base::Manager::Data STYLESHEET_DEFAULT_CUSTOM_CORE_MANAGER_DATA = {
    .app = {
        .max_running_num = 3,
    },
    .flags = {
...
constexpr const char *STYLESHEET_DEFAULT_CUSTOM_CORE_INFO_DATA_NAME = "Default Custom";

constexpr base::Context::Data STYLESHEET_DEFAULT_CUSTOM_CORE_DATA = {
    .name = STYLESHEET_DEFAULT_CUSTOM_CORE_INFO_DATA_NAME,
    .screen_size = gui::StyleSize::RECT_PERCENT(100, 100),
    .display = STYLESHEET_DEFAULT_CUSTOM_CORE_DISPLAY_DATA,
    .manager = STYLESHEET_DEFAULT_CUSTOM_CORE_MANAGER_DATA,
};
