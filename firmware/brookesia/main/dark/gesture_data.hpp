...
constexpr Gesture::IndicatorBarData STYLESHEET_DEFAULT_CUSTOM_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA = {
    .main = {
...
constexpr Gesture::IndicatorBarData STYLESHEET_DEFAULT_CUSTOM_GESTURE_BOTTOM_INDICATOR_BAR_DATA = {
    .main = {
...
constexpr Gesture::Data STYLESHEET_DEFAULT_CUSTOM_GESTURE_DATA = {
    .detect_period_ms = 20,
    .threshold = {
    ...
    .indicator_bars = {
        ...
        STYLESHEET_DEFAULT_CUSTOM_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA,
        [static_cast<int>(Gesture::IndicatorBarType::RIGHT)] =
        STYLESHEET_DEFAULT_CUSTOM_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA,
        [static_cast<int>(Gesture::IndicatorBarType::BOTTOM)] =
        STYLESHEET_DEFAULT_CUSTOM_GESTURE_BOTTOM_INDICATOR_BAR_DATA,
    },
    .flags = {
