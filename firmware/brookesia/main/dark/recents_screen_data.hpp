...
constexpr RecentsScreenSnapshot::Data STYLESHEET_DEFAULT_CUSTOM_RECENTS_SCREEN_SNAPSHOT_DATA = {
...
constexpr RecentsScreen::Data STYLESHEET_DEFAULT_CUSTOM_RECENTS_SCREEN_DATA = {
    .main = {
        .y_start = 0,
    ...
    .snapshot_table = {
        ...
        .snapshot = STYLESHEET_DEFAULT_CUSTOM_RECENTS_SCREEN_SNAPSHOT_DATA,
    },
    .trash_icon = {
