...
constexpr StatusBar::AreaData STYLESHEET_DEFAULT_CUSTOM_STATUS_BAR_AREA_DATA(int w_percent, StatusBar::AreaAlign align)
{
    return {
...
constexpr StatusBar::Data STYLESHEET_DEFAULT_CUSTOM_STATUS_BAR_DATA = {
    .main = {
    ...
    .area = {
        // Use one centered area so battery, Wi-Fi, and clock align as a compact group.
        .num = 1,
        .data = {
            STYLESHEET_DEFAULT_CUSTOM_STATUS_BAR_AREA_DATA(100, StatusBar::AreaAlign::CENTER),
        },
    },
