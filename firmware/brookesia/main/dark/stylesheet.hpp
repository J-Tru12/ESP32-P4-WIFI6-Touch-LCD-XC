...
constexpr Display::Data STYLESHEET_DEFAULT_CUSTOM_DISPLAY_DATA = {
    .status_bar = {
        .data = STYLESHEET_DEFAULT_CUSTOM_STATUS_BAR_DATA,
        .visual_mode = StatusBar::VisualMode::SHOW_FIXED,
    },
    .navigation_bar = {
        .data = STYLESHEET_DEFAULT_CUSTOM_NAVIGATION_BAR_DATA,
        .visual_mode = NavigationBar::VisualMode::HIDE,
    },
    .app_launcher = {
        .data = STYLESHEET_DEFAULT_CUSTOM_APP_LAUNCHER_DATA,
        .default_image = gui::StyleImage::IMAGE(&esp_brookesia_image_small_app_launcher_default_98_98),
    },
    .recents_screen = {
        .data = STYLESHEET_DEFAULT_CUSTOM_RECENTS_SCREEN_DATA,
...
constexpr Manager::Data STYLESHEET_DEFAULT_CUSTOM_MANAGER_DATA = {
    .gesture = STYLESHEET_DEFAULT_CUSTOM_GESTURE_DATA,
...
constexpr Stylesheet STYLESHEET_DEFAULT_CUSTOM = {
    .core = STYLESHEET_DEFAULT_CUSTOM_CORE_DATA,
    .display = STYLESHEET_DEFAULT_CUSTOM_DISPLAY_DATA,
    .manager = STYLESHEET_DEFAULT_CUSTOM_MANAGER_DATA,
};

} // namespace esp_brookesia::systems::phone

#define ESP_BROOKESIA_PHONE_DEFAULT_CUSTOM_STYLESHEET() esp_brookesia::systems::phone::STYLESHEET_DEFAULT_CUSTOM
