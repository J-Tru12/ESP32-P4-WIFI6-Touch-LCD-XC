...
extern "C" void app_main(void)
{
    ...
    ESP_UTILS_LOGI("Using stylesheet (%s)", STYLESHEET_DEFAULT_CUSTOM.core.name);
    ESP_UTILS_CHECK_FALSE_EXIT(phone->addStylesheet(STYLESHEET_DEFAULT_CUSTOM), "Add stylesheet failed");
    ESP_UTILS_CHECK_FALSE_EXIT(phone->activateStylesheet(STYLESHEET_DEFAULT_CUSTOM), "Activate stylesheet failed");

    {
        ...
        auto round_prototype_app = esp_brookesia::apps::RoundPrototype::requestInstance();
        ESP_UTILS_CHECK_FALSE_EXIT(phone->installApp(round_prototype_app), "Start RoundPrototype failed");
